package com.pole6lynn.animationdemo.ui;
...
import com.pole6lynn.animationdemo.R;
...
public class RevealLayout extends LinearLayout implements Runnable {
    ...
    public RevealLayout(Context context, AttributeSet set) {
        super(context, set);
        init();
    }

    public RevealLayout(Context context, AttributeSet set, int defStyleAttr) {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        this.getLocationOnScreen(mLocationOnScreen);
    }
    ...
    private void initParametersForChild(MotionEvent event, View view) {
        ...
        int[] location = new int[2];
        view.getLocationOnScreen(location);
        int left = location[0] - mLocationOnScreen[0];
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        int left = location[0] - mLocationOnScreen[0];
        int top = location[1] - mLocationOnScreen[1];
